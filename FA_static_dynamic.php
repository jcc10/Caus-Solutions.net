...
function sd_head() {
	$tab = "\t\t\t\t";
	echo "$tab<h1>Fake-Ad's</h1>\n$tab<h2><a href=\""$sd_host"/index.php\"><em>C&#225;us Solutions</em></a> Mirror</h2>\n$tab<br />\n$tab<hr />";
}
...
//Set Constants for the menu's (I NEED TO MAKE A CONFIGURATION FILE SOON :P)
function sd_con(){
	define("sd_host", "http://www.caus-solutions.com");
	define("sd_root", "");
}
?>