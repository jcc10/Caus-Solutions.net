...
function sd_side($origin) {
	...
	$tmpItem = sd_ticket ."/";
	sd_side_item("On-line Support Tickets", $tmpItem, $origin);
	$tmpItem = sd_root . "/Services.php";
	sd_side_item("Our Services", $tmpItem, $origin);
	$tmpItem = sd_fake_ads . "/index.php";
	sd_side_item("Fake Ad's", $tmpItem, $origin);
	$tmpItem = sd_root . "/PayPalPWYW.php";
	sd_side_item("Online Donations", $tmpItem, $origin);
